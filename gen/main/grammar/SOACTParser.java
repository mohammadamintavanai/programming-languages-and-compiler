// Generated from E:/PLC_TA/Fall-1403-project/Phase2/Project/src/main/grammar/SOACT.g4 by ANTLR 4.13.1
...
public class SOACTParser extends Parser {
	...
	public static final int
		...
		RULE_arrayType = 12, RULE_authorized = 13, RULE_accesslevels = 14, RULE_accesslevelsParam = 15, 
	...
	public final ActorDecContext actorDec() throws RecognitionException {
		...
		try {
			...
			if (_la==ACTORVAR) {
				...
				_localctx.actorDecRet.setActorVars(((ActorDecContext)_localctx).v.argRet);
				}
			}
	...
	public final ActorVarsContext actorVars() throws RecognitionException {
		...
		try {
			...
			setState(185);
			match(ACTORVAR);
			((ActorVarsContext)_localctx).argRet =  new ArrayList<>();
			setState(187);
			match(LBRACE);
			setState(200);
			_errHandler.sync(this);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68920836116L) != 0) || _la==IDENTIFIER) {
				...
				_localctx.argRet.add(((ActorVarsContext)_localctx).var.varRet);
				setState(194);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==LPAR) {
	...
	public final AuthorizedContext authorized() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_authorized);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(288);
	...
	public final AccesslevelsContext accesslevels() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_accesslevels);
		try {
			enterOuterAlt(_localctx, 1);
			{
